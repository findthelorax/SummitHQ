        ...
        () => [
            ...
            },
            {
                ...
                cellRendererParams: generateActionCellRendererParams<EquipmentRow>(
                    ...
                    async (row: EquipmentRow) => {
                        const fixedUpdate = normalizeEquipmentUpdate(row) as Partial<EquipmentWithLocation>;
        ...
        <EntityTableAgGrid
            ...
            agGridContext={{
                ...
                updateEntity: async (id: string, update: Partial<EquipmentRow>) => {
                    const fixedUpdate = normalizeEquipmentUpdate(update) as Partial<EquipmentWithLocation>;
