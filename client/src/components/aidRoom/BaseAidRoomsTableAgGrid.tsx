...
// Types & Enums
import type { BaseAidRoomsTableAgGridProps } from '../../utils/AgGrid/tableTypes';
...
const BaseAidRoomsTableAgGrid: React.FC<BaseAidRoomsTableAgGridProps> = ({
    aidRooms,
    fetchAidRooms,
    isLoading,
    updateAidRoom,
    ...
    const columnDefs = useMemo(
        ...
        [fetchAidRooms, mountainName, areas]
    );

    const rowData = useMemo(() => aidRooms.map(mapAidRoomToRow), [aidRooms, areas]);
...
export default BaseAidRoomsTableAgGrid;