...
import LocationModel from '../../models/mountains/locationModel';
...
class LocationController {
    ...
    async addIncidentToLocation(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { locationId } = req.params;
    ...
    async deleteIncidentFromLocation(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { locationId, incidentId } = req.params;
