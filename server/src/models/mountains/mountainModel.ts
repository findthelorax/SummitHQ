...
class MountainModel {
	...
	static async update(mountainId: string, updatedData: any) {
		const safeData = {
			...updatedData,
			latitude:
				updatedData.latitude !== null && updatedData.latitude !== undefined
					? new Decimal(updatedData.latitude)
					: null,
			longitude:
				updatedData.longitude !== null && updatedData.longitude !== undefined
					? new Decimal(updatedData.longitude)
					: null,
			height:
				updatedData.height !== null && updatedData.height !== undefined
					? new Decimal(updatedData.height)
					: null,
